		...
		<div class="row">
			...
			<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2 bg-faded sidebar-style-1 titulo  " >
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
					<li class="nav-item my-3"><a class="nav-link active" href="#" ><em class="fa fa-dashboard"></em> visita</a></li>
	            ...
	            <div class="container-fluid">
	                <div class="row">
	                    <div class="col-md-12">
											 ...
											 <p class="category">Especificaciones  de visitas</p>
											 		 </div>
											 			<div class="card-content table-responsive">
											 				 <table class="table" id="tabla-trabajador">
											 						 <thead class="text-primary">
                                     ...
                                     <th id="id">Id</th>
																		  ...
																		  <th id="apellido">Apellido</th>
																			<th id="apellido">Numero de identificación </th>
											 							 <th id="fecha-reserva">fecha Reserva </th>
																		 <th id="fecha-reserva">fecha visita </th>
											 							 <th id="t-pagar">Total</th>
