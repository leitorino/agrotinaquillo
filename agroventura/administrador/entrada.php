		...
		<div class="row">
			...
			<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2 bg-faded sidebar-style-1 titulo  " >
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
					...
					<li class="nav-item my-3"><a class="nav-link " href="administrador.php" role="tab" data-toggle="tab"><em class="fa fa-clone"></em> Trabajador  <span class="sr-only">(current)</span></a></li>
				</ul>
	                            ...
	                            <div class="card-content">
	                                <form>
                                        ...
                                        <div class="form-group group ">
	                                        ...
	                                        <div class="col-md-4">				
                                            <div class="form-group group ">
													<input type="text" class="input2" id="impuesto-r" required>
                                                      <span class="highlight"></span>
                                                      <span class="bar"></span>
                                        ...
                                        <div class="form-group group ">
													<input type="textarea" class="input2" id="id-r" disabled>
                                                      <span class="highlight"></span>
                                                      <span class="bar"></span>
                                        ...
                                        <div class="form-group group ">
													<input type="text" class="input2" id="general-r" required>
                                                      <span class="highlight"></span>
                                                      <span class="bar"></span>
	                                        ...
	                                        <div class="col-md-4">                            			
                                           <div class="form-group group ">
													<input type="text" class="input2" id="niño-r" required>
                                                      <span class="highlight"></span>
                                                      <span class="bar"></span>
                                            ...
                                            <div class="form-group group ">
													<input type="text" class="input2" id="3edad-r" required>
                                                      <span class="highlight"></span>
                                                      <span class="bar"></span>
