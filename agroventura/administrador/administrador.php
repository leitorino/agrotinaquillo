	                        ...
	                        <div class="card">
	                            ...
	                            <div class="card-content">
	                                <form>
	                                    <div class="row my-3">
	                                        ...
	                                        <div class="col-md-5">
												<div class="form-group group ">
													<input type="text" class="input2" id="usuario-r" required>
	                                       ...
	                                       <div class="col-md-3">
												<div class="form-group group ">
													<input type="email" class="input2" id="correo-r"  required>
                                                      <span class="highlight"></span>
                                                      <span class="bar"></span>
	                                        ...
	                                        <div class="col-md-4">
												<div class="form-group group ">
													<input type="email" class="input2" id="telefono-r" required>
                                                      <span class="highlight"></span>
                                                      <span class="bar"></span>
                                        ...
                                        <div class="col-md-5">
												<div class="form-group group ">
													<input type="password" class="input2" id="contraseña-r" required>
                                                      <span class="highlight"></span>
                                                      <span class="bar"></span>
	                                        ...
	                                        <div class="col-md-3">
												<div class="form-group group ">
													<input type="text" class="input2" id="codigo-r" required>
                                                      <span class="highlight"></span>
                                                      <span class="bar"></span>
                                         ...
                                         <div class="row">
	                                        ...
	                                        <div class="col-md-6">
												<div class="form-group group ">
													<input type="text" class="input2" id="n-documento-r" required>
                                                      <span class="highlight"></span>
                                                      <span class="bar"></span>
	                                    ...
	                                    <div class="row my-5">
	                                        ...
	                                        <div class="col-md-6">
												<div class="form-group group ">
													<input type="text" class="input2" id="nombre-r" required>
                                                      <span class="highlight"></span>
                                                      <span class="bar"></span>
	                                        ...
	                                        <div class="col-md-6">
												<div class="form-group group ">
													<input type="test" class="input2" id="apellidos-r" required>
                                                      <span class="highlight"></span>
                                                      <span class="bar"></span>
	                                    ...
	                                    <div class="row">
	                                        ...
	                                        <div class="col-md-8">
												<div class="form-group group ">
													<input type="text" class="input2" id="direccion-r" required>
                                                      <span class="highlight"></span>
                                                      <span class="bar"></span>
