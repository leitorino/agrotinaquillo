		...
		<div class="row">
			...
			<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2 bg-faded sidebar-style-1 titulo  " >
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
					<li class="nav-item my-3"><a class="nav-link active " href="#" ><em class="fa fa-cutlery"></em> Control de productos</a></li>
					<li class="nav-item my-3"><a class="nav-link" href="administrador.php" ><em class="fa fa-user"></em> Trabajador</a></li>
					<li class="nav-item my-3"><a class="nav-link " href="../administrador/entrada.php" ><em class="fa fa-calendar-o"></em> Control de entradas </a></li>
					<li class="nav-item my-3"><a class="nav-link" href="../administrador/caney.php"><em class="fa  fa-home "></em> Control Caney </a></li>
	                            ...
	                            <div class="card-content">
	                                ...
	                                <form class="formulario" name="formulario-r">
	                                    <div class="row my-3 ">
	                                        ...
	                                        <div class="col-md-5 ">
												<div class="form-group group ">
													<input type="text" class="input2" id="nombre-r" maxlength="60" name="nombre-r"  required>
	                                        ...
	                                        <div class="col-md-4">
												<div class="form-group group ">
													<input type="text" class="input2 val-numero" id="precio-r"maxlength="11" name="precio-r"  required>
                                                      <span class="highlight"></span>
                                                      <span class="bar"></span>
                                        ...
                                        <div class="row my-5">
	                                        <div class="col-md-6">
												<div class="form-group group ">
													<input type="text" class="input2" id="descripcion-r" maxlength="100" name="descripcion-r"  required>
                                                      <span class="highlight"></span>
                                                      <span class="bar"></span>
	                                ...
	                                <table class="table" id="tabla-trabajador">
	                                    ...
	                                    <tbody><div>
	                                        ...
	                                        <tr>
	                                        	...
	                                        	<td class="td-actions text-right">
												<a class="editar" data-toggle="modal" data-target="#nuevo-trabajador"class="editar" data-toggle="modal" data-target="#nuevo-trabajador" href="#" ><i title="Editar" class="fa fa-pencil" style="color:green" aria-hidden="true"></i></a>
                                                <a href="#" ><i title="Eliminar" class="fa fa-times mx-3 " style="color:red" aria-hidden="true"></i></a>
